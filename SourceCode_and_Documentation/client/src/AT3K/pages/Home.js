                ...
                <Container>
                    ...
                    <div className={styles.container}>
                        ...
                        <p className={styles.bodyText}>
                            <strong>employ.me</strong> is your own personalised app that you can use to search and apply for jobs! The app also has many features that can be customised to your preferences without taking away the ease and simplicity of the design.
                            <br></br>
                            <br></br>
                            ...
                            <br></br>
                            <br></br>
                            Get a head-start and begin searching for your new career <strong>employ.me</strong>! Register or log in if you already have an account.
                            <br></br>
                            <br></br>
